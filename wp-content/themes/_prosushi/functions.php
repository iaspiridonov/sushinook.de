...
/*
	if ($order_data['shipping_total']>0){ // если доставка больше нуля - доабвляем 500 доставку из товаров.
		$product[]="200000000";
		$product_kol[]=1;
	}
...
fclose($dh);*/
	...
	$ch = curl_init();
	curl_setopt($ch, CURLOPT_URL, "https://prosushi.kz/google/insert3.php");
	curl_setopt($ch, CURLOPT_FAILONERROR, 1);
	curl_setopt($ch, CURLOPT_RETURNTRANSFER,1);
	curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
	curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, false);
...
function custom_override_checkout_fields( $fields ) {
	...
	$fields['billing']['billing_kod'] = array(
	 'type' => 'text', 
	 'label' => __('Код из смс', 'woocommerce'),
	 'placeholder' => _x('Код из смс', 'placeholder', 'woocommerce'),
	 'required' => true,
