...
!function (a) {
    ...
    function h(f, g, i) {
            ...
            keydownEvent: function (b) {
                ...
                if (y().join("") !== d) {
                    ...
                    if (d = d.replace(new RegExp("(" + e.escapeRegex(x().join("")) + ")*"), ""), k) {
                        var g = d.replace(y().join(""), "");
                        if (1 === g.length) {
                            var h = new a.Event("keypress");
                            return h.which = g.charCodeAt(0), da.keypressEvent.call(c, h, !0, !0, !1, o().validPositions[f.begin - 1] ? f.begin : f.begin - 1), !1
                        }
                    }
                    if (f.begin > d.length && (L(c, d.length), f = L(c)), y().length - d.length !== 1 || d.charAt(f.begin) === y()[f.begin] || d.charAt(f.begin + 1) === y()[f.begin] || D(f.begin)) {
                        ...
                        var p = L(c).begin, q = c.inputmask._valueGet();
                        if (0 === q.indexOf(j[0]) && p !== j[0].length)L(c, j[0].length), m && setTimeout(function () {
                            L(c, j[0].length)
                        }, 0); else {
                            for (; null === q.match(e.escapeRegex(j[1]) + "$");)j[1] = j[1].substr(1);
                            var r = q.indexOf(j[1]);
                            r !== -1 && "" !== j[1] && p > r && (L(c, r), m && setTimeout(function () {
                                L(c, r)
                            }, 0))
                        }
        ...
        if (f !== d)switch (f.action) {
            ...
            case"remove":
                if (Y) {
                    U = a(Y), Y.inputmask._valueSet(K(Y)), ca.off(Y);
                    var ha;
    ...
    return e.prototype = {
        ...
        analyseMask: function (b, c) {
            ...
            for (var k, l, m, n, o, p, q, r = /(?:[?*+]|\{[0-9\+\*]+(?:,[0-9\+\*]*)?\})|[^.?*+^${[]()|\\]+|./g, s = !1, t = new f, u = [], v = []; k = r.exec(b);)if (l = k[0], s)i(); else switch (l.charAt(0)) {
                case c.escapeChar:
                    s = !0;
                    break;
                ...
                case c.quantifiermarker.start:
                    var x = new f((!1), (!1), (!0));
                    l = l.replace(/[{}]/g, "");
                    var y = l.split(","), z = isNaN(y[0]) ? y[0] : parseInt(y[0]), A = 1 === y.length ? z : isNaN(y[1]) ? y[1] : parseInt(y[1]);
    ...
    return b.extendAliases({
        numeric: {
            ...
            postValidation: function (d, e, f) {
                ...
                l !== c && l !== f.radixPoint && l !== f.negationSymbol.front && l !== f.negationSymbol.back && (k[j] = "?", f.prefix.length > 0 && j >= (f.isNegative === !1 ? 1 : 0) && j < f.prefix.length - 1 + (f.isNegative === !1 ? 1 : 0) ? i[j - (f.isNegative === !1 ? 1 : 0)] = "?" : f.suffix.length > 0 && j >= k.length - f.suffix.length - (f.isNegative === !1 ? 1 : 0) && (h[j - (k.length - f.suffix.length - (f.isNegative === !1 ? 1 : 0))] = "?")),
                    i = i.join(""), h = h.join("");
