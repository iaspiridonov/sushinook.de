...
<div class="form-tab-rcl" id="remember-form-rcl">
    ...
    <span class="form-title">1<?php _e('Password generation','wp-recall'); ?></span>
    ...
    <?php if(!isset($_GET['success'])){ ?>
        <form action="<?php echo wp_lostpassword_url(); ?>" method="post">
            <div class="form-block-rcl default-field">
                <input type="text" placeholder="<?php _e('Username or e-mail','wp-recall'); ?>" value="" name="user_login">
